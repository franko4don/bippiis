...
import { Loader } from '../../Reusables/Loaders/Loader';
import {toggleShowImageModal, captureUpdate} from './../../../redux/actions';
...
class Camera extends Component {
  ...
  startTimer(){
    ...
    interval = setInterval(() => {
      if(this.state.count == 0){
        this.setState({loading: false, count: 5});
        this.takePicture();
        this.stopTimer();
      }else{
  ...
  takePicture = async function() {
    if (this.camera) {
        ...
        ToastAndroid.show('Picture captured', ToastAndroid.SHORT)
...
export default connect(mapStateToProps, {toggleShowImageModal, captureUpdate})(Camera);