        ...
        return (
            ...
            <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{ flexGrow: 1}} style={{backgroundColor: BACKGROUND}}>
                ...
                <View style={{flexDirection: 'row', margin: 5,  justifyContent: 'space-between'}}>
                    <HomeSection 
                        onPress={() => {
                            if(this.props.user.lga_pensioners.face_capture){
                ...
                <View style={{flexDirection: 'row', marginLeft: 5, marginRight: 5, marginBottom: 20, marginTop: 20, justifyContent: 'space-between'}}>
                    ...
                    <HomeSection style={{opacity: 0}} disabled={true} onPress={() => Actions.staffid()} name="Staff Identity Card" image={<StaffIdIcon/>}/>
                </View>
...
export default connect(mapStateToProps, {getUserData, logoutUser})(PensionHome);
