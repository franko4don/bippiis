 ...
 *  Before this activity is called, it is assummed that this person logged in as so his/her fingerprints are still in
 *  
...
public class QuarterlyVerificationWithFingerprint extends AppCompatActivity
    ...
    public void LogAsDialog(String logStr) {
        ...
        Tools.toast(logStr, QuarterlyVerificationWithFingerprint.this);
    }
